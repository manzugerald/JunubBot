...
class StreamListener(tweepy.Stream):
    ...
    def on_status(self, status):
        ...
        if not status.is_quote_status:
            ...
            'nuer tribe', 'dinka tribe', 'killing','genocide', 'Turkey', 'Russia', 'China', 'India', '18 year old goalkeeper',
            'Ethiopia','DECLARED WAR','email list','peed','wetted']
            blocked_words_final = []
...
stream  = StreamListener(consumer_key=CONSUMER_KEY, consumer_secret = CONSUMER_SECRET, access_token = ACCESS_KEY, access_token_secret= ACCESS_SECRET)
